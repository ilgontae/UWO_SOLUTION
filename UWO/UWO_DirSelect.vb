...
Public Class UWO_DirSelect
    ...
    Private Sub B_Compare_Click(ByVal sender As Object, ByVal e As EventArgs) Handles B_Compare.Click
    ...
    Private Sub B_Cancel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles B_Cancel.Click
        Me.Close()
    End Sub

    Private Sub B_Dir1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles B_Dir1.Click
        FED_Dir1.ShowDialog()
        TB_Dir1.Text = FED_Dir1.SelectedPath
    End Sub

    Private Sub B_Dir2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles B_Dir2.Click
        FED_Dir2.ShowDialog()
        TB_Dir2.Text = FED_Dir2.SelectedPath
    End Sub

    Private Sub UWO_DirSelect_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    End Sub

    Private Sub TB_Dir1_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles TB_Dir1.TextChanged
    ...
    Private Sub TB_Dir2_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles TB_Dir2.TextChanged
