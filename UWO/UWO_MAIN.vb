...
'Called PerformClick() located in UWO_CONVERTION 
...
Public Class UWO_MAIN
    ...
    Private Sub CONVERTToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CONVERTToolStripMenuItem.Click
        ...
        Else
			...
			answer = MessageBox.Show("Would you like to convert" + vbCrLf + "your graphic to web pages?" + vbCrLf + "Click No for more options", "Convertion", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)
			If answer = Windows.Forms.DialogResult.Yes Then
                UWO_CONVERTION.MdiParent = Me
                UWO_CONVERTION.Show()
                UWO_CONVERTION.timeTextBox.Text = 1
                UWO_CONVERTION.DriveComboBox.Text = "Z:\Graphics"
                UWO_CONVERTION.startButton.PerformClick()
            Else
                UWO_CONVERTION.Show()
                UWO_CONVERTION.MdiParent = Me
            End If
