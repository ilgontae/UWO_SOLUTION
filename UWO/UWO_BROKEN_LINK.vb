...
Public Class UWO_BROKEN_LINK
	...
	Private Sub FindStr(ByVal fname As String)
		Try
			...
			While x < txtLength
				If allRead(x) = "(" Then
					If String.Compare(allRead.Substring(x - 7, 8), "replace(", True) = 0 Or
					   String.Compare(allRead.Substring(x - 4, 5), "goto(", True) = 0 Then
						...
						While x < txtLength
							...
							Else
								Exit While
							End If
							If String.Compare(link, "BAC", True) = 0 Or
