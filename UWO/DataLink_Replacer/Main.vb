...
Public Class Main
    ...
    Private Sub FindStr(ByVal fname As String)
        Try
            ...
            testTxt.Close()
            Dim regMatch As String = TB_Find.Text
    ...
    Private Sub B_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles B_Save.Click
        ...
        SFD_SaveList.FileName = "DLR_" + TB_Find.Text
        SFD_SaveList.Filter = "Text Files (*.txt)|*.txt|Excel Files (*.xls)|*.xls"
        SFD_SaveList.InitialDirectory = TB_Directory.Text
...
SendKeys.SendWait("{ENTER}")
                ...
                num += 1
            Next
            MessageBox.Show("COMPLETE" + vbCrLf + _
                            "It Ts Recommended To Save The list" + vbCrLf + _
                            "If You Have Not Already Done So.", "LINKS REPLACED", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch
            MessageBox.Show("You Must Login To ORCAView", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
